...
public class Cong_tru_nhan_chia_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTroVe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Cong_tru_nhan_chia_Activity.this, MainActivity.class);
